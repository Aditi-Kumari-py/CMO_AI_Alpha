...
export default function DepartmentsTab() {
  ...
  useEffect(() => {
    fetch("https://backend-znxf.onrender.com/departments")
      .then((res) => res.json())
  ...
  const handleSaveEdit = (index) => {
    if (editedName.trim() !== "") {
      fetch(`https://backend-znxf.onrender.com/departments/${departments[index].name}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleDelete = (name) => {
    fetch(`https://backend-znxf.onrender.com/departments/${name}`, { method: "DELETE" })
